...
<head>
    ...
    <title>${currBookType.name} - ${siteName}</title>
...
<body>
    ...
    <div class="layui-main">
        <ul class="layui-tree">
            ...
            <li<c:if test="${currBookType.id == tmp.id}"> class="this"</c:if>><a href="./btype/${tmp.id}"><cite>${tmp.name}</cite></a></li>
            </c:forEach>
        </ul>
        <div class="content">
            ...
            <h2 class="page-title">${currBookType.name} 下的所有图书：</h2>
            <c:choose>
